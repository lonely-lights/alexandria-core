...
return [
    ...
    'mobile.structure' => 'Structure',
    'mobile.view' => 'View',
    'mobile.companions' => 'Companions',
    'mobile.tools' => 'Tools',
    'mobile.writing_desk' => 'Writing Desk',
    'mobile.open_writing_desk' => 'Open Writing Desk',
    'mobile.actions' => 'Actions',
    'mobile.review_insights' => 'Review & Insights',
    'mobile.workspace_settings' => 'Workspace Settings',
    'mobile.project' => 'Project',
    'mobile.structure_description' => 'Move through sections and manage their structure.',
    'mobile.view_description' => 'Current view: :view. Change modes and display options.',
    'mobile.review_insights_description' => 'Reports, history, craft review, devices, and tropes.',
    'mobile.workspace_settings_description' => 'Manuscript, current section, and writing environment.',
    'mobile.project_description' => 'Project home, notes, AI, and related destinations.',
    'mobile.installed_modules' => 'Installed Modules',
    'mobile.installed_modules_description' => ':count custom module(s) available with your companions.',
    'mobile.open_structure_for_section' => 'Open Structure for :section',
    'mobile.view_current' => 'View: :view',
    'mobile.back' => 'Back',
    'mobile.close' => 'Close',
    'mobile.search_tools' => 'Search writing tools',
    'mobile.search_actions' => 'Search writing actions',
    'mobile.workspace_surfaces' => 'Workspace',
    'mobile.companions_description' => 'Linked items, notes, comments, outline, history, and threads.',
    'mobile.comments_description' => 'Review and add comments for the current section.',
    'mobile.search_alexandria' => 'Search Alexandria',
    'mobile.search_alexandria_description' => 'Find settings and project content.',
    'mobile.pinned' => 'Pinned',
    'mobile.destinations' => 'Project destinations',
    'mobile.no_tools_found' => 'No writing tools match that search.',
    'mobile.no_actions_found' => 'No writing actions match that search.',
    'mobile.no_settings_available' => 'No workspace settings are available in the current context.',
    'mobile.no_formatting_available' => 'No formatting controls are available in the current context.',
    'mobile.unavailable' => 'Unavailable in the current context',
    'mobile.apply' => 'Apply',
    'mobile.history_description' => 'Review saved revisions and restore earlier work.',
    'mobile.devices_tropes_description' => 'Track planted devices, tropes, and open promises.',
    'mobile.editing_tools' => 'Writing controls',
    'mobile.change_style' => 'Change paragraph style. Current: :style',
    'mobile.format' => 'Format',
    'mobile.selection_actions' => 'Selection actions',
    'mobile.dismiss_keyboard' => 'Dismiss keyboard',
    'mobile.select_text_for_context' => 'Select text to add a comment or mark a device. Entry links remain available at the caret.',
    'mobile.comment_selection_description' => 'Anchor a comment to the selected text.',
    'mobile.mark_selection_description' => 'Mark the selected text as part of a device or trope.',
