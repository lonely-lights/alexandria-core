...
return [
    ...
    // ── Recycle Bin (Stage 11 Slice 4; multi-type since Devices & Tropes rework-6) ──
    'recycle_bin.col.type' => 'Type',
    'recycle_bin.col.entry' => 'Name',
    'recycle_bin.col.context' => 'Context',
    'recycle_bin.col.deleted' => 'Deleted',
    'recycle_bin.col.select_all' => 'Select all',
    'recycle_bin.search_placeholder' => 'Search…',
    'recycle_bin.filter.all_types' => 'All types',
    'recycle_bin.filter.all_blueprints' => 'All blueprints',
    'recycle_bin.type.entry' => 'Entry',
    'recycle_bin.type.work' => 'Work',
    'recycle_bin.type.section' => 'Section',
    ...
    'recycle_bin.summary.singular' => ':count deleted item',
    'recycle_bin.summary.plural' => ':count deleted items',
    'recycle_bin.empty' => 'The bin is empty',
    'recycle_bin.no_results' => 'No items match your filters',
];
