...
return [
    ...
    // Heading of the settings result group in the global command palette.
    'search.group' => 'Settings',

    // -- Settings nav labels (nav-config.ts `label` keys) ------------
    'nav.profile' => 'Profile',
    ...
    'nav.pref-appearance' => 'Appearance',
    'nav.pref-behavior' => 'Behavior',
    'nav.pref-workspace' => 'Workspace',
    'nav.pref-language' => 'Formats',
    'nav.pref-notifications' => 'Notifications',
    'nav.privacy' => 'Privacy',
    'nav.privacy-visibility' => 'Visibility',
    'nav.privacy-settings' => 'Privacy',
    'nav.privacy-lists' => 'Lists',
    'nav.tools' => 'Tools',
    'nav.tools-editor' => 'Editor',
    'nav.tools-shortcuts' => 'Shortcuts',
    'nav.tools-integrations' => 'Integrations',
    'nav.ai' => 'AI',
    'nav.ai-connection' => 'Connection',
    'nav.ai-models' => 'Models',
    'nav.ai-usage' => 'Usage',
    'nav.ai-preferences' => 'Preferences',
    'nav.accessibility' => 'Accessibility',
    'nav.a11y-visual' => 'Visual',
    'nav.a11y-motion' => 'Motion',
    'nav.a11y-assistive' => 'Assistive',

    // -- Settings search synonyms (nav-config.ts `searchTermsKey`) ----
    // One string per section, `|`-separated: control names and synonyms
    // that should surface the owning section in Settings search.
    'nav_terms.identity' => 'Display Name|Username|Avatar|Profile Picture|Banner|Pronouns',
    'nav_terms.about' => 'Tagline|Biography|Bio|Private Bio',
    'nav_terms.details' => 'Location|Website|Birthday|Date of Birth',
    'nav_terms.links' => 'Social Links|Website Links|Support Links',
    'nav_terms.account' => 'Email|Password|Delete Account',
    'nav_terms.security' => 'Two-factor Authentication|2FA|Recovery Codes',
    'nav_terms.pref-appearance' => 'Color Mode|Light Mode|Dark Mode|System Mode|Font Size|Theme|Theme Preset|Fine-tune Theme',
    'nav_terms.pref-behavior' => 'Hover-off Auto-dismiss|Menu Auto-dismiss|Menu Dismiss Delay|Hover Behavior',
    'nav_terms.pref-workspace' => 'Compact Mode|Dense Layout|Show Section Type Labels|Act Labels|Scene Labels|Writing Workspace',
    'nav_terms.pref-language' => 'Date Format|Time Format|First Day of Week|Number Format|Regional Formats',
    'nav_terms.pref-notifications' => 'Email Notifications|Push Notifications|In-App Notifications|Mentions|Comments|Project Invites|Product Updates',
    'nav_terms.privacy-visibility' => 'Field Visibility|Profile Visibility',
    'nav_terms.privacy-settings' => 'Online Status|Activity Status|Project Invites',
    'nav_terms.privacy-lists' => 'Privacy Lists|Custom Groups|Access Lists',
    'nav_terms.tools-editor' => 'Default Editor Mode|Auto-Save|Spell Check|Word Count|Reading Time|Note Visibility',
    'nav_terms.tools-shortcuts' => 'Keyboard Shortcuts|Key Bindings|Hotkeys',
    'nav_terms.tools-integrations' => 'Connected Apps|Google Drive|Dropbox|Notion',
    'nav_terms.ai-connection' => 'API Keys|AI Providers|Bring Your Own Key',
    'nav_terms.ai-models' => 'AI Model Selection|Default Model',
    'nav_terms.ai-usage' => 'AI Usage|Tokens|Monthly Usage',
    'nav_terms.ai-preferences' => 'AI Suggestions|Response Length|Auto-categorize',
    'nav_terms.a11y-visual' => 'High Contrast|Focus Indicators|Dyslexia-Friendly Font',
    'nav_terms.a11y-motion' => 'Reduced Motion|Reduce Motion|Animations|Transitions',
    'nav_terms.a11y-assistive' => 'Screen Reader Mode|Keyboard Shortcuts|Assistive Technology',
