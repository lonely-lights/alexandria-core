...
@section('subject', app(\Alexandria\Core\Mail\BrandedTextResolver::class)->get('reset', 'subject'))
...
@section('content')
    ...
    <p style="margin:0 0 12px; font-size:13px; color:#78716c;">
        @brandedString('reset.expiry_note', ['minutes' => $expiryMinutes])
    </p>

    <p style="margin:0; font-size:13px; color:#78716c;">
        @brandedString('reset.fallback')
    </p>
@endsection
