...
const subtitle60: CSSProperties = { color: 'color-mix(in srgb, var(--theme-base-content) 60%, transparent)' };
...
const subtitle30: CSSProperties = { color: 'color-mix(in srgb, var(--theme-base-content) 30%, transparent)' };

const btnClass = 'inline-flex items-center justify-center px-3 py-1 text-sm font-medium';
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
                {fields.map((field, index) => {
                    ...
                    return (
                        <div key={`${field.id ?? 'new'}-${index}`} style={fieldRowStyle}>
                            {/* Field header */}
                            <div
                                ...
                                <div className="min-w-0 flex-1">
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-medium">
                                            {field.label || <span className="italic" style={subtitle30}>Untitled field</span>}
                                        </span>
                                        {field.is_required && <span style={requiredBadgeStyle}>Required</span>}
                                    </div>
                                    <div className="flex items-center gap-2 text-xs" style={subtitle40}>
                            ...
                            {/* Expanded config */}
                            {isExpanded && (
                                <div className="px-4 py-4" style={expandedPanelStyle}>
                                    ...
                                    {field.type === 'entry_reference' && (
                                        <div className="mt-3 space-y-3 p-4" style={violetPanelStyle}>
                                            <Select
                                                label="Choose List"
                                    ...
                                    {field.type === 'relationship_manager' && (
                                        <div className="mt-3 p-4" style={rosePanelStyle}>
                                            <Select
                ...
                {fields.length === 0 && (
                    <div className="py-12 text-center" style={emptyStateStyle}>
                        <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full" style={emptyIconWrapStyle}>
                            <i className="fa-solid fa-layer-group text-xl" style={subtitle30} />
                        </div>
                        <p className="font-medium" style={subtitle50}>No fields defined</p>
                        <p className="mt-1 text-sm" style={subtitle40}>Add fields to define the structure of entries using this blueprint.</p>
                    </div>
                )}
            </div>
            ...
            {isDirty && (
                <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2">
                    <div className="flex items-center gap-3 px-6 py-3" style={saveBarStyle}>
