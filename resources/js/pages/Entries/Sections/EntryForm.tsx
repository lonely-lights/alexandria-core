...
const iconWrapStyle: CSSProperties = {
    ...
    borderRadius: "var(--theme-radius-card)",
    boxShadow:
        "0 0 0 1px color-mix(in srgb, var(--theme-base-content) 5%, transparent), 0 4px 6px -1px rgb(0 0 0 / 0.1)",
};
...
export default function EntryForm({
    ...
    /* ── Smart slug ──
       The slug auto-generates from the name when the user leaves the
       name field (create always; edit only after an actual rename), via
       a server round-trip that slugifies + reserves a unique value.
       Hand-editing the slug marks it touched so name changes stop
       overwriting it; blurring the slug field canonicalizes whatever
       was typed the same way. */
    const [slugTouched, setSlugTouched] = useState(false);
    const initialName = initialValues?.name ?? "";

    function fetchSlugPreview(base: string) {
        if (!base.trim()) return;
        ...
        fetch(
            ...
            .then((r) => r.json())
            .then((data) => {
                if (data.slug) form.setData("slug", data.slug);
            })
            .catch(() => {});
    }
    ...
    function handleNameBlur() {
        ...
        if (mode === "edit" && form.data.name === initialName) return;
        fetchSlugPreview(form.data.name);
    }

    function handleSlugBlur() {
        if (!form.data.slug.trim()) {
            // Cleared: fall back to auto-generation from the name
            setSlugTouched(false);
            fetchSlugPreview(form.data.name);
            return;
        }
        fetchSlugPreview(form.data.slug);
    }
                ...
                <div className="min-w-0 flex-1 space-y-6">
                        ...
                        <div className="overflow-hidden" style={cardInnerStyle}>
                            ...
                            <div className="px-8 py-5">
                                <Textarea
                                    ...
                                    placeholder={t(
                                        "entries.form.summary_placeholder",
                                    )}
                                    rows={2}
                                />
                            </div>
                    ...
                    <div className="paper-board" style={cardOuterStyle}>
                        <div className="p-6" style={cardInnerStyle}>
                            ...
                            >
                                {t("entries.form.content_heading")}
                            </h2>
                            <textarea
                                ...
                                placeholder={t(
                                    "entries.form.content_placeholder",
                                )}
                                rows={16}
                ...
                <div className="w-80 flex-shrink-0 space-y-6">
                        ...
                        <div className="paper-board" style={cardOuterStyle}>
                            ...
                            >
                                <div
                                    ...
                                    style={sectionHeaderSecondaryStyle}
                                >
                                    <i
                                        className="fa-solid fa-layer-group text-xs"
                                        style={sectionIconSecondaryStyle}
                                    />
                                    <h3 className="text-xs font-semibold">
                                        {t("entries.form.fields_heading")}
                                    </h3>
                    ...
                    {entryId && (
                        <div className="paper-board" style={cardOuterStyle}>
                            ...
                            >
                                <div
                                    className="flex items-center gap-2 px-4 py-3"
                                    style={sectionHeaderAccentStyle}
                                >
                                    <i
                                        className="fa-solid fa-photo-film text-xs"
                                        style={sectionIconAccentStyle}
                                    />
                                    <h3 className="text-xs font-semibold">
                        ...
                        <div className="paper-board" style={cardOuterStyle}>
                            <div className="p-4" style={cardInnerStyle}>
                                <label
                                    ...
                                    style={fieldLabelStyle}
                                >
                                    {t("entries.form.parent_label")}
                                </label>
                                <p
                                    className="mb-2 mt-0.5 text-[10px]"
                                    style={fieldDescStyle}
                                >
                    ...
                    <div className="space-y-2">
                        <ActionButton
                            ...
                            label={
                                mode === "create"
                                    ? t("entries.form.action.create").replace(
                                          ":blueprint",
                                          blueprintName,
                                      )
...
const temporalRemoveStyle: CSSProperties = {
    ...
    borderRadius: "var(--theme-radius-input)",
    transition:
        "color var(--theme-motion-duration-fast, 150ms) ease, opacity 200ms ease",
};
...
const temporalAddBtnStyle: CSSProperties = {
    ...
    borderTop:
        "1px solid color-mix(in srgb, var(--theme-base-content) 10%, transparent)",
    transition:
        "background-color var(--theme-motion-duration-fast, 150ms) ease, color var(--theme-motion-duration-fast, 150ms) ease",
};

function TemporalFieldEditor({
    field,
    records,
    onChange,
}: {
    ...
    const intensityLabel =
        (config.intensity_label as string) ??
        t("entries.form.temporal.intensity_default");
    ...
    return (
        <div className="paper-board" style={cardOuterStyle}>
            <div className="overflow-hidden" style={cardInnerStyle}>
                ...
                >
                    <i
                        className="fa-solid fa-timeline text-xs"
                        style={sectionIconSecondaryStyle}
                    />
                    ...
                    <span style={sectionCountBadgeStyle}>
                        {t(
                            records.length === 1
                                ? "entries.form.temporal.record_count.singular"
                                : "entries.form.temporal.record_count.plural",
                ...
                <div>
                    {records.map((record, i) => (
                        <div
                            ...
                            style={i > 0 ? fieldDividerStyle : undefined}
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex flex-col items-center pt-3">
                                    <div
                                        ...
                                        style={
                                            record.end
                                                ? temporalDotDoneStyle
                                                : temporalDotActiveStyle
                                        }
                                    />
                                    <div
                                        className="mt-1 w-px flex-1"
                                        style={temporalLineStyle}
                                    />
                                </div>
                                ...
                                <div className="min-w-0 flex-1 space-y-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            placeholder={t(
                                                "entries.form.temporal.title_placeholder",
                                            )}
                                            style={{
                                                ...fieldRowInputStyle,
                                                width: "50%",
                                        ...
                                        <input
                                            ...
                                            placeholder={t(
                                                "entries.form.temporal.end_placeholder",
                                            )}
                                        />
                                    </div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder={t(
                                            "entries.form.temporal.notes_placeholder",
                                        )}
                                        rows={2}
                ...
                >
                    ...
                    {t("entries.form.temporal.add").replace(
                        ":label",
                        field.label,
                    )}
                </button>
...
const slugIconStyle: CSSProperties = {
    color: "color-mix(in srgb, var(--theme-base-content) 30%, transparent)",
};
...
export function DynamicFieldInput({
    ...
    switch (field.type) {
            ...
            return (
                <div className="space-y-1.5">
                    {items.map((item, i) => (
                        <div key={i} className="flex items-center gap-1.5">
                            ...
                            <button
                                ...
                                className="alex-btn alex-btn--ghost flex h-7 w-7 flex-shrink-0 items-center justify-center"
                                title={t("entries.form.multi_remove")}
                            >
                    ...
                    <button
                        ...
                        className="alex-btn alex-btn--ghost inline-flex items-center gap-1.5 px-2 py-1 text-xs"
                    >
                        <i className="fa-solid fa-plus text-[10px]" />{" "}
                        {t("entries.form.multi_add")}
                    </button>
                </div>
            );
        }
            ...
            return (
                <label className="flex cursor-pointer items-center gap-2">
                    ...
                    <span className="text-xs" style={booleanLabelStyle}>
                        {value
                            ? t("entries.form.boolean.yes")
                            : t("entries.form.boolean.no")}
                    </span>
                </label>
            );
        case "date":
        ...
        case "stardate":
            return (
                <StardateInput value={value} onChange={(v) => onChange(v)} />
            );
        default:
            return (
                <input
...
function EntryReferencePicker({
    ...
    if (!config)
        return (
            <span className="text-xs" style={pickerPlaceholderStyle}>
                {t("entries.form.reference.no_config")}
            </span>
        );
            ...
            >
                {selectedNames.length > 0 ? (
                    isMulti ? (
                        ...
                        <span style={pickerSelectedTextStyle}>
                            {selectedNames[0]}
                        </span>
                    )
                ) : (
                    <span style={pickerPlaceholderStyle}>
                        {t("entries.form.reference.placeholder").replace(
                            ":label",
                            field.label,
                        )}
                    </span>
...
const closeBtnStyle: CSSProperties = {
    ...
    color: "color-mix(in srgb, var(--theme-base-content) 60%, transparent)",
    transition:
        "background-color var(--theme-motion-duration-fast, 150ms) ease",
};
    ...
    async function createNewEntry() {
        ...
        try {
            const res = await fetch(
                `/api/v1/blueprints/by-slug/${initialConfig.target_blueprint_slug}/quick-create`,
                {
                    method: "POST",
                    headers: {
                        Accept: "application/json",
            ...
            <div className="flex flex-col max-h-[70vh]">
                ...
                >
                    <div>
                        ...
                        >
                            {initialConfig.target_blueprint_name ??
                                t(
                                    "entries.form.reference_modal.subtitle_fallback",
                                )}
                            {isMulti &&
                                t(
                                    "entries.form.reference_modal.subtitle_multi_suffix",
                                )}
                        </p>
                    </div>
                    <button
                ...
                {isMulti && localSelected.length > 0 && (
                    <div className="px-5 py-3" style={modalHeaderDivider}>
                        <div
                            ...
                            style={selectedHeadingStyle}
                        >
                            {t(
                                "entries.form.reference_modal.selected_heading",
                            ).replace(":count", String(localSelected.length))}
                        </div>
                        <div
                            ref={sortableRef}
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                placeholder={t(
                                    "entries.form.reference_modal.search_placeholder",
                                )}
                                autoFocus
                ...
                {isMulti && (
                    <div
                        ...
                        style={{ borderTop: "1px solid var(--theme-base-300)" }}
                    >
                        <span className="text-xs" style={footerCountStyle}>
                            {t(
                                "entries.form.reference_modal.selected_count",
                            ).replace(":count", String(localSelected.length))}
                        </span>
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                style={footerApplyStyle}
                            >
                                {t("entries.form.reference_modal.apply")}
                            </button>
                        </div>
                    </div>
                )}
...
function buildInitialFields(
    ...
    for (const field of fields) {
        ...
        } else if (field.type === "text_multiple") {
            // Server collapses a single row to a scalar — normalize to a list
