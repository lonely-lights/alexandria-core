...
| durationInput.ts | Strict duration parsing and formatting |
...
**Files:** Create core `pacing/{pacingTypes,durationInput,pacingModel,pacingAdapters}.ts`. Create app `resources/js/editor/tests/pacing-model.test.ts`, `duration-input.test.ts`.
